...
export function HomeIcon({ color, size = 24, strokeWidth = 2 }: TabIconProps) {
	return (
...
export function CalendarIcon({ color, size = 24, strokeWidth = 2 }: TabIconProps) {
	return (
		<Svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth={strokeWidth} strokeLinecap="round" strokeLinejoin="round">
...
export function NotesIcon({ color, size = 24, strokeWidth = 2 }: TabIconProps) {
	return (
		<Svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth={strokeWidth} strokeLinecap="round" strokeLinejoin="round">
...
export function WellbeingIcon({ color, size = 24, strokeWidth = 2 }: TabIconProps) {
	return (
		<Svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth={strokeWidth} strokeLinecap="round" strokeLinejoin="round">
...
export function ScanIcon({ color, size = 24, strokeWidth = 2 }: TabIconProps) {
	return (
		<Svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth={strokeWidth} strokeLinecap="round" strokeLinejoin="round">
